...
static const char WINDOW_TITLE[] = "TD03 Exercice 3";
...
// J'ai décidé de ne pas faire drawRoundedSquare
...
GLuint createSecondArmIDList(){
    // Pour les cotés j'aurais du utiliser drawRoundedSquare que je n'ai pas codé
        ...
        while(SDL_PollEvent(&e)) 
        {
            ...
            switch(e.type) 
            {
                ...
                case SDL_MOUSEBUTTONUP:
                    ...
                    if(e.button.button == SDL_BUTTON_LEFT)beta+=5;
                    if(e.button.button == SDL_BUTTON_RIGHT)beta-=5;
                    break;
